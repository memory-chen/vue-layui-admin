  ...
  <div id="tableData">
    <table class="layui-table">
      ...
      <thead>
        <tr>
          <th>
            <div @click="allChecked(AllcheckClick)" v-show="AllcheckClick" class="layui-unselect layui-form-checkbox layui-form-checked" lay-skin="primary"><i class="layui-icon"></i></div>
            <div @click="allChecked(AllcheckClick)" v-show="!AllcheckClick" class="layui-unselect layui-form-checkbox" lay-skin="primary"><i class="layui-icon"></i></div>
          </th>
...
export default {
  ...
  methods: {
    ...
    // 全选、全不选
    allChecked(AllcheckClick) {
      console.log(AllcheckClick);
